      ...
      {word.map((letter) => {
        return (
          <div key={letter.id} className={`overflow-hidden pt-5 xxl:pt-8`}>
            <p
              className={`text-[12rem] text-right w-full  md:text-[13rem] lg:text-[18rem] desktop:text-[20rem] xxl:text-[25rem] leading-[0.7] font-Humane transiton transform duration-[1800ms]  ${
