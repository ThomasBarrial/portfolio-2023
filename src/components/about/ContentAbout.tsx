...
function ContentAbout() {
  ...
  return (
    <div
      ref={ref}
      className="mt-5 flex  w-full  max-w-[150rem]  flex-col px-5  pb-20 font-Antonio lg:px-10"
    >
  ...
  own identity and style.`}
        ...
        <AnimUp inView={inView} duration={2} className="mt-5">
  ...
  technical skill.`}
        ...
        <AnimUp inView={inView} duration={2.5} className="mt-10 flex space-x-2">
      ...
      <div className=" mt-20 flex w-full flex-col lg:flex-row lg:items-end lg:justify-end">
        <div className="w-full  lg:w-3/4">
          <AnimUp inView={inView} duration={2.7}>
