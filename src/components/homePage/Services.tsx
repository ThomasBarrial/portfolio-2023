...
function Services() {
  ...
  return (
    <div className="h-screen w-screen relative flex  flex-col items-center justify-center px-5 lg:px-20">
      <div
        ref={ref}
      ...
      >
        <div className="w-full h-full font-Antonio flex flex-col justify-start lg:pt-32 pt-32 md:pt-20  md:pl-52 xl:pl-64 max-w-5xl pl-20 ">
          ...
          {inView && (
            <AnimUp duration={2.5}>
              <p className="mt-2">
                I am an web and mobile developer, capable of creating
                ...
                solutions to help my clients achieve their online business
                goals.
              </p>
            </AnimUp>
          )}
