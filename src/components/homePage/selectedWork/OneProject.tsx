...
function OneProject({ project }: IProps) {
  ...
  return (
    ...
    >
      ...
      {inProjectView && (
        <AnimUp duration={1.5}>
          <div className="w-full lg:w-8/12 cursor-pointer h-[220px] phone:h-[400px] md:h-[550px] relative">
            <Image
      ...
      <div className="pt-5 lg:pt-5 h-24">
        {inProjectView && (
          <AnimUp duration={1.5}>
            <div className="flex flex-col items-end lg:flex-row font-Antonio text-sm  w-full md:w-full  pb-10">
